...
var project_graph_1 = require('@nx/workspace/src/core/project-graph');
var create_package_json_1 = require('@nx/workspace/src/utilities/create-package-json');
...
function packageExecutor(options, context) {
  ...
  return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
    ...
    return (0, tslib_1.__generator)(this, function (_s) {
      ...
      packageJson = (0, create_package_json_1.createPackageJson)(
        (_a = context.projectName) !== null && _a !== void 0 ? _a : 'project',
        projGraph,
        {
          root: context.root,
        }
      ...
      for (
        _i = 0,
          _e = Object.entries(packageJson.dependencies).sort(function (a, b) {
            return a[0] < b[0] ? -1 : 1;
          });
        _i < _e.length;
        _i++
        ...
        omit = false;
        for (
          _g = 0, _h = (_b = options.omit) !== null && _b !== void 0 ? _b : [];
          _g < _h.length;
          _g++
        ) {
          pattern = _h[_g];
      ...
      if (
        (_c = options.include) === null || _c === void 0 ? void 0 : _c.length
      ) {
        rootPackageJson = void 0;
        try {
          rootPackageJson = JSON.parse(
            fs.readFileSync(path.join(context.root, 'package.json'), 'utf-8')
          );
        } catch (e) {
          throw e;
        }
        for (
          _j = 0, _k = Object.entries(rootPackageJson.dependencies);
          _j < _k.length;
          _j++
        ) {
          ...
          for (
            _m = 0,
              _o = (_d = options.include) !== null && _d !== void 0 ? _d : [];
            _m < _o.length;
            _m++
          ) {
            pattern = _o[_m];
      ...
      if (fs.existsSync(sourcePackageJsonPath)) {
        ...
        for (
          _p = 0, _q = Object.entries(sourcePackageJson);
          _p < _q.length;
          _p++
        ) {
